...
-- Legacy cleanup for old table naming
...
-- =====================================
INSERT INTO notices (id, title, content, date, type, priority, views, is_new, pdf_url)
VALUES (
  1,
...
INSERT INTO news (id, title, excerpt, content, date, author, department, tags, category, priority, views, likes, image_url, featured, status)
VALUES (
  1,
