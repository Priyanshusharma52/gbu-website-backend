...
-- =====================================
INSERT INTO notices (title, content, published_date, type, priority, views, is_new, pdf_url)
VALUES (
...
INSERT INTO news (title, excerpt, content, author, department, category, published_date, priority, views, likes, is_featured, status, image_url, tags)
VALUES (
  ...
  '["AI", "Research", "Innovation", "Technology"]'::jsonb
);
...
INSERT INTO events (
  ...
  '["Tech", "Symposium", "Engineering"]'::jsonb,
...
-- =====================================
INSERT INTO media_gallery (id, title, category, year, published_date, images) VALUES
(1, '15th Annual Convocation Ceremony', 'Convocation', '2025', '2025-05-12', '["https://www.ic3ecsbhi.com/Gallery/20231224_134240.jpg", "https://www.ic3ecsbhi.com/Events/IMG-20231224-WA0082.jpg", "https://hostels.gbu.ac.in/uploads/eventsfiles/photos/65a98a5384fb0_GBU-Convocation.jpeg"]'::jsonb),
...
-- CHECK DATA
-- =====================================
SELECT COUNT(*) AS notices_count FROM notices;
SELECT COUNT(*) AS news_count FROM news;
SELECT COUNT(*) AS events_count FROM events;
SELECT COUNT(*) AS media_gallery_count FROM media_gallery;
